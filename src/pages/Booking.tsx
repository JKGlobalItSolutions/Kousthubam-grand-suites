...
const Booking = () => {
  ...
  const fetchHotel = async () => {
    try {
      ...
      setHotelError(err.message || 'Failed to fetch hotel');
    } finally {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
              ...
              <div>
                <button
                  ...
                  className="w-full text-primary-foreground hover-glow-purple px-4 py-2 rounded-md transition-all duration-300 font-medium"
                  style={{

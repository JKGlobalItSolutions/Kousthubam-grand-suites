...
import { FaWifi, FaParking, FaSnowflake, FaUtensils, FaCoffee, FaDumbbell, FaSwimmingPool, FaConciergeBell, FaPhone, FaEnvelope, FaMapMarkerAlt, FaFacebook, FaInstagram, FaTwitter, FaLinkedin } from "react-icons/fa";
...
const Index = () => {
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <button
                ...
                className="w-full hover:bg-primary-glow text-primary-foreground hover-glow-purple px-4 py-2 rounded-md transition-all duration-300 button-bg"
          ...
          {mobileMenuOpen && (
            ...
            >
              ...
              <button
                onClick={() => scrollToSection("rooms")}
                className="w-full hover:bg-primary-glow text-primary-foreground hover-glow-purple px-4 py-2 rounded-md transition-all duration-300"
                style={{backgroundColor:"#9234DB"}}
              >
                Book Now
              </button>
  ...
  const Amenities = () => {
    ...
    const amenities = [
      ...
      { icon: FaUtensils, title: "Fine Dining", description: "Multi-cuisine restaurant with authentic flavors" },
      { icon: FaCoffee, title: "Café & Bar", description: "24/7 café and premium bar service" },
      { icon: FaDumbbell, title: "Fitness Center", description: "Fully equipped modern gym facilities" },
      { icon: FaSwimmingPool, title: "Swimming Pool", description: "Refreshing outdoor pool with lounge area" },
      { icon: FaConciergeBell, title: "24/7 Concierge", description: "Round-the-clock assistance and room service" },
    ];
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      123 Temple Road, Near Arunachaleswarar Temple<br />
              ...
              <div className="bg-card border border-border rounded-lg p-6 hover-glow-purple">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      info@kousthubamgrand.com<br />
                      reservations@kousthubamgrand.com
                    </p>
                  </div>
                </div>
              </div>
